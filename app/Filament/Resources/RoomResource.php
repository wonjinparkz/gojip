...
class RoomResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                LayoutView::make('filament.resources.room-resource.table.room-card')
            ...
            ->actions([
                Action::make('view')
                    ->label('상세정보')
                    ->modalHeading(fn ($record) => "{$record->room_number}호 상세정보")
                    ->modalWidth(Width::FourExtraLarge)
                    ->modalContent(fn ($record) => view('filament.resources.room-resource.modals.view-room', [
                        'record' => $record
                    ]))
                ...
                Action::make('edit')
                    ->label('수정하기')
                    ->modalHeading(fn ($record) => "{$record->room_number}호 수정")
                    ->modalWidth(Width::FourExtraLarge)
            ...
            ->recordUrl(null); // Disable default row click navigation
    }
